...
PUBLIC_CLAIM_CHANNEL_PHONE_EMAIL = "phone_email"
VALID_PUBLIC_CLAIM_CHANNELS = frozenset(
    {PUBLIC_CLAIM_CHANNEL_PHONE, PUBLIC_CLAIM_CHANNEL_EMAIL, PUBLIC_CLAIM_CHANNEL_PHONE_EMAIL}
)
