...
// 상담(코드) 플랫폼 컬렉션: @/types/firestore (assessments, testResults)
...
// ---------------------------------------------------------------------------
// 상담(코드) 플랫폼: assessments / testResults (타입·컬렉션은 @/types/firestore)
// ---------------------------------------------------------------------------
...
export const testResultsFirestore = {
  ...
  /** assessmentId 로 해당 상담(코드) 세트의 모든 결과 조회 (진행 현황용) */
