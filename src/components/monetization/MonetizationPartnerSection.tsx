  ...
  return (
    <HomeSectionShell tone="partner" className="py-16 md:py-20" showBottomFade={false}>
      <div className="container max-w-4xl mx-auto px-4 text-center">
        <h2 className={`${homeContentClasses.sectionTitle} mb-4`}>
          파트너 · 기관 도입 문의
        </h2>
        <p className={`${homeContentClasses.sectionSubtitle} mb-8 max-w-xl mx-auto`}>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <Link
            href="/partners/"
            className="inline-flex justify-center items-center px-6 py-3 rounded-xl border border-slate-300 text-slate-700 font-semibold hover:bg-white transition-colors"
          >
            기관 · B2B 안내
          </Link>
        </div>
