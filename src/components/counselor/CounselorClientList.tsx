...
export default function CounselorClientList() {
  ...
  return (
    <CounselorPageSection
      ...
      title="내담자 목록"
      description="발급한 나의코드(내 검사실) 내담자를 한곳에서 조회합니다. 검사 진행·발송 현황은 상담패키지별 진행현황에서 상세히 확인할 수 있습니다."
      toolbar={
        <>
                  ...
                  >
                    ...
                    <td className="px-4 py-3 text-xs text-slate-300">
                      ...
                      {item.assignedAssessmentCount > 0 ? (
                        <div className="text-slate-500">상담패키지 {item.assignedAssessmentCount}건</div>
                      ) : null}
                    </td>
