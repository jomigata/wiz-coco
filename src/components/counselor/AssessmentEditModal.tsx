...
export default function AssessmentEditModal({ open, assessmentId, onClose, onSaved }: Props) {
  ...
  return createPortal(
    ...
    >
      <div
        className="my-2 flex max-h-[96dvh] w-full max-w-[min(80rem,calc(100vw-1rem))] flex-col overflow-hidden rounded-2xl border border-sky-400/20 bg-gradient-to-b from-[#0f1a2e] to-[#0a1220] shadow-2xl sm:my-4"
