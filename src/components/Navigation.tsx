            ...
            {isLoggedIn ? (
              <>
                ...
                <div className="relative" ref={dropdownRef}>
                  {isDropdownOpen && (
                    <div
                        className="absolute right-0 mt-0 pt-0 pb-8 w-96 bg-gradient-to-br from-slate-900/95 via-blue-900/95 to-indigo-900/95 rounded-2xl shadow-2xl border border-emerald-500/30 z-50 animate-fadeIn backdrop-blur-xl"
                        onMouseEnter={() => setActiveMenu('user')}
                        onMouseLeave={() => setActiveMenu(null)}
                      >
                        {/* 사용자 정보 헤더 - 고급 버전 */}
