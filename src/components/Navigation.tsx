              ...
              <>
                  {/* 사용자 정보 표시 - 최신 디자인 */}
                    ...
                    <div className="flex items-center gap-1">
                      {/* 즐겨찾기 아이콘 */}
                      <Link href="/mypage?tab=favorites" className="p-1.5 rounded-lg bg-pink-500/20 text-pink-300 hover:text-white hover:bg-pink-500/40 transition-all duration-300 group">
