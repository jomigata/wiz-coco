...
const MbtiProClientInfo: FC<MbtiProClientInfoProps> = ({ onSubmit, isPersonalTest, initialData, onBack, screenTitle }) => {
      ...
      <div className="max-w-2xl mx-auto relative z-10">
        ...
        >
          ...
          >
            ...
            <div className={`flex ${onBack ? 'justify-between' : 'justify-end'} items-center pt-4 ${showYearSelector ? 'opacity-30 pointer-events-none' : ''}`}>
              {onBack && (
              <motion.button
                type="button"
