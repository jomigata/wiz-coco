              ...
              <div className="flex flex-col gap-8">
                <div className="relative flex justify-between items-end gap-3 px-4">
                  ...
                  <button
                    ...
                    className={`group relative py-8 px-4 flex-1 rounded-[20px] bg-emerald-800/40 transition-all duration-300 border border-emerald-700/20 ${isMouseMoved ? 'hover:bg-emerald-800/60 hover:translate-y-[-2px]' : ''}`}
                  >
                  ...
                  <button
                    ...
                    className={`group relative py-8 px-4 flex-1 rounded-[20px] bg-emerald-800/40 transition-all duration-300 border border-emerald-700/20 ${isMouseMoved ? 'hover:bg-emerald-800/60 hover:translate-y-[-2px] hover:shadow-lg hover:shadow-emerald-900/20' : ''}`}
                  >
