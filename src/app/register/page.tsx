      ...
      <div className="flex-grow flex items-center justify-center px-4 py-12">
        <div className="max-w-md w-full space-y-8 bg-emerald-900/30 p-8 rounded-2xl backdrop-blur-sm border border-emerald-800/50">
          <div className="text-center">
            ...
            <p className="text-emerald-400">카카오로 빠르게 가입하거나 이메일로 계정을 만들 수 있어요.</p>
          </div>

          <div className="space-y-3 mt-2">
            <p className="text-center text-sm text-emerald-300/90">간편 가입</p>
            <motion.button
              type="button"
              onClick={() => handleSocialLogin('kakao')}
              className="group relative flex w-full justify-center items-center gap-2 px-4 py-4 rounded-xl border border-black/10 bg-[#FEE500] text-[#191919] font-semibold text-base shadow-md hover:bg-[#F5DC00] focus:outline-none focus:ring-2 focus:ring-[#FEE500]/80 focus:ring-offset-2 focus:ring-offset-emerald-950 transition-all"
            ...
            <div className="grid grid-cols-2 gap-3">
              <motion.button
                ...
                className="group relative flex justify-center items-center px-3 py-3 border border-white/10 bg-white text-gray-800 rounded-xl hover:bg-gray-50 transition-all shadow-sm"
              ...
              <motion.button
                ...
                className="group relative flex justify-center items-center px-3 py-3 border border-[#03C75A] bg-[#03C75A] text-white rounded-xl hover:bg-[#02b351] transition-all shadow-sm"
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
                disabled={isLoading}
                aria-label="네이버로 가입"
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-emerald-900/30 text-emerald-500">또는 이메일로 가입</span>
            </div>
          </div>
          ...
          <form className="space-y-6" onSubmit={handleRegister}>
            ...
            <div>
              <motion.button
                type="submit"
                className="group relative w-full flex justify-center py-3 px-4 border border-emerald-600/50 text-base font-medium rounded-xl text-emerald-100 bg-emerald-900/40 hover:bg-emerald-800/50 focus:outline-none focus:ring-2 focus:ring-emerald-500/60 transition-all"
                whileHover={{ scale: 1.01 }}
                whileTap={{ scale: 0.99 }}
                disabled={isLoading}
              ...
              >
                {isLoading ? (
                  <div className="flex items-center">
                    <svg className="animate-spin -ml-1 mr-2 h-5 w-5 text-emerald-200" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
