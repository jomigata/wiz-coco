...
function TestRecordsContent() {
  ...
  const viewTestDetail = (code: string) => {
    ...
    // 상담(코드)를 로컬 스토리지에 저장하여 결과 페이지가 확인할 수 있도록 함
    try {
        ...
        {!user ? (
          ...
          <>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 shadow-lg border border-white/20">
              ...
              {showStats ? (
                <div className="mb-6">
                  <h3 className="text-xl font-semibold text-white mb-5 border-b border-white/10 pb-2">상담(코드) 통계 대시보드</h3>
