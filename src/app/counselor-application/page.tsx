...
export default function CounselorApplicationPage() {
  ...
  if (!user?.uid) {
    return (
      <div className="min-h-[calc(100dvh-4rem)] bg-[#0b1120] pt-20 flex items-center justify-center px-4">
  ...
  return (
    <div className="min-h-[calc(100dvh-4rem)] bg-[#0b1120] pt-20 pb-8 px-4">
