...
export default function CounselorApplicationPage() {
  ...
  if (loading) {
    return (
      <div className="min-h-[calc(100dvh-4rem)] bg-[#070b14] pt-20 flex items-center justify-center text-slate-400 text-sm">
        불러오는 중…
      </div>
    );
  }
  ...
  if (!user?.uid) {
    return (
      <div className="min-h-[calc(100dvh-4rem)] bg-[#070b14] pt-20 flex items-center justify-center px-4">
        <div className="max-w-sm w-full rounded-2xl border border-white/10 bg-slate-900/80 p-8 text-center">
  ...
  return (
    <div className="min-h-[calc(100dvh-4rem)] bg-[#070b14] pt-20 pb-8 px-4">
