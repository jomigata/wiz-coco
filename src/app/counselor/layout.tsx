...
export default function CounselorLayout({ children }: { children: React.ReactNode }) {
  ...
  const counselorMenuCategories = [
    ...
    },
    {
      ...
      subItems: [
        { id: 'dispatch-status', label: '검사발송 목록', href: '/counselor/clients', icon: 'M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z' },
    ...
    },
    {
      ...
      subItems: [
        ...
        { id: 'test-codes', label: '상담코드 관리', href: '/counselor/test-codes', icon: 'M15 7a2 2 0 012 2m4 0a6 6 0 01-7.743 5.743L11 17H9v2H7v2H4a1 1 0 01-1-1v-2.586a1 1 0 01.293-.707l5.964-5.964A6 6 0 1121 9z' }
      ]
    },
    {
      id: 'tools-resources',
      ...
      subItems: [
        ...
        { id: 'portal-chat', label: '1:1 채팅', href: '/counselor/chat', icon: 'M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z' },
  ...
  const getActiveSection = (path: string): string => {
    ...
    if (path.startsWith('/counselor/chat')) return 'portal-chat';
    if (path.startsWith('/counselor/progress')) return 'assessments-list';
  ...
  const getPageTitle = (path: string): string => {
    ...
    const titleMap: { [key: string]: string } = {
      '/counselor': '오늘',
      '/counselor/clients': '검사발송 목록',
      '/counselor/clients/detail': '검사발송 목록',
