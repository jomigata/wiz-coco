...
import SeniorAssessmentListEasy from '@/components/counselor/senior/SeniorAssessmentListEasy';
import { AuthLoadingState, AuthRequiredState } from '@/components/auth/AuthStatusViews';
import { useCounselorAssessmentsPage } from '@/hooks/useCounselorAssessmentsPage';

export default function AssessmentsEasyPage() {
  ...
  return <SeniorAssessmentListEasy assessments={assessments} revalidating={revalidating} />;
}
