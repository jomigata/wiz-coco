  ...
  return (
    <div className="space-y-6">
      ...
      <p className="text-slate-400 text-sm">
        안내 제목, 대상, 안내 메시지, 포함할 검사를 설정하면 고유 <strong className="text-slate-200">검사코드</strong>와{' '}
        <strong className="text-slate-200">4자리 비밀번호</strong>가 함께 발급됩니다.
        내담자는 회원가입 없이{' '}
        <AuthLink href="/join/" className="text-sky-400 hover:text-sky-300 underline">
          검사 시작
        </AuthLink>
        에서 코드와 비밀번호를 입력해 검사실에 들어갑니다.
      </p>
