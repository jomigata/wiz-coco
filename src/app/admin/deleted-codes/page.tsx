            ...
            <div className="max-w-7xl mx-auto relative z-10">
              ...
              >
                ...
                <p className="mt-4 text-blue-100 max-w-2xl">
                  삭제된 상담(코드)를 관리하고 복구할 수 있습니다. 총 <span className="font-semibold">{deletedRecords.length + permanentlyDeletedRecords.length}</span>개의 삭제된 코드가 있습니다.
                </p>
              </motion.div>
