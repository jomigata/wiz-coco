...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  function getActiveSection(path: string) {
    ...
    if (path.includes('/admin/commerce')) return 'commerce';
    ...
    if (path.includes('/admin/permanently-deleted')) return 'permanently-deleted';
  ...
  const adminMenuCategories = [
    ...
    },
    {
      ...
      subItems: [
        ...
        { id: 'commerce', label: '포인트 · 수익화', href: '/admin/commerce', icon: 'M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z' },
        { id: 'organizations', label: 'B2B 기관 관리', href: '/admin/organizations', icon: 'M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4' },
    ...
    },
    {
      ...
      subItems: [
        ...
        { id: 'permanently-deleted', label: '영구 삭제 보관함', href: '/admin/permanently-deleted', icon: 'M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16' },
