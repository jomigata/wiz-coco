      ...
      <div className="flex-grow flex items-center justify-center px-4 py-12">
        <div className="max-w-md w-full space-y-8 bg-emerald-900/30 p-8 rounded-2xl backdrop-blur-sm border border-emerald-800/50">
          <div className="text-center">
            ...
            <p className="text-emerald-400">카카오 등 SNS로 빠르게 시작하거나 이메일로 로그인할 수 있어요.</p>
          </div>
          ...
          <div className="space-y-3 mt-2">
            <p className="text-center text-sm text-emerald-300/90">
              {showSnsLogin ? '아래 버튼으로 소셜 로그인을 진행해 주세요.' : '간편 로그인'}
            </p>
            <motion.button
            ...
            <>
              <div className="relative pt-2">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-2 bg-emerald-900/30 text-emerald-500">또는 이메일로 로그인</span>
                </div>
              </div>
