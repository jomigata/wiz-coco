...
export default function PsychologyTestsPage() {
  ...
  const quickAccessItems = [
    {
      ...
      stats: { value: '45', label: '총', change: '인기 12개' }
    },
    {
      title: '에니어그램 검사',
      description: '9가지 성격유형과 동기 분석',
      href: '/tests/enneagram',
      icon: '⭐',
      color: 'from-green-500 to-emerald-500',
      stats: { value: '9', label: '유형', change: '보통 20분' }
    },
    {
      title: '빅파이브 성격검사',
      description: '5가지 성격 차원 측정',
      href: '/tests/big-five',
      icon: '📊',
      color: 'from-purple-500 to-pink-500',
      stats: { value: '5', label: '차원', change: '보통 25분' }
    },
    {
      title: '기질검사 (TCI)',
      description: '기질과 성격 차원 분석',
      href: '/tests/tci',
      icon: '🧠',
      color: 'from-orange-500 to-red-500',
      stats: { value: '기질', label: '성격', change: '어려움 30분' }
    },
    {
      title: '검사 결과 분석',
  ...
  const recentActivities = [
    { action: '새로운 상담 완료', client: '세로운 상담 완료', time: '30분 전', type: 'counseling' },
    { action: '검사 결과 분석 완료', client: '검사 결과 분석 완료', time: '1시간 전', type: 'test' },
    { action: '치료 계획 업데이트', client: '치료 계획 업데이트', time: '14시간 전', type: 'treatment' },
    { action: '상담 노트 작성', client: '상담 노트 작성', time: '1시간 전', type: 'note' },
    { action: '진행 상황 업데이트', client: '진행 상황 업데이트', time: '30분 전', type: 'progress' }
  ];
