      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-slate-900">자존감 및 자기 문제</h1>
              <p className="text-slate-600 text-lg mt-2">낮은 자존감, 자기 비난, 완벽주의 등 자기 자신과 관련된 문제를 다룹니다.</p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-8 bg-slate-50 rounded-xl p-6 border border-slate-200">
          <div className="text-center">
            <h3 className="text-lg font-semibold text-slate-900 mb-2">💪 자존감 향상 안내</h3>
