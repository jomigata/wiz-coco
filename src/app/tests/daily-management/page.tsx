      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-slate-900">일상생활 및 자기 관리</h1>
              <p className="text-slate-600 text-lg mt-2">시간 관리, 생활 습관, 자기 관리 등 일상생활의 어려움을 해결합니다.</p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-8 bg-slate-50 rounded-xl p-6 border border-slate-200">
          <div className="text-center">
            <h3 className="text-lg font-semibold text-slate-900 mb-2">📅 일상 관리 향상 안내</h3>
