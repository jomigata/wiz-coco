      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-slate-900">중독 및 충동 조절 문제</h1>
              <p className="text-slate-600 text-lg mt-2">물질 및 행위 중독, 성인 ADHD 등 충동 조절의 어려움을 해결합니다.</p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-8 bg-slate-50 rounded-xl p-6 border border-slate-200">
          <div className="text-center">
            <h3 className="text-lg font-semibold text-slate-900 mb-2">🔗 중독 및 충동 조절 안내</h3>
