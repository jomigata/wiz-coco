      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-slate-900">친구 및 동료 관계</h1>
              <p className="text-slate-600 text-lg mt-2">친구, 직장 동료와의 관계에서 발생하는 갈등과 소통 문제를 해결합니다.</p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-8 bg-slate-50 rounded-xl p-6 border border-slate-200">
          <div className="text-center">
            <h3 className="text-lg font-semibold text-slate-900 mb-2">👥 인간관계 상담 안내</h3>
