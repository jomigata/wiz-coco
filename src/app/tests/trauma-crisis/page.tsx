      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-slate-900">외상 및 위기 개입</h1>
              <p className="text-slate-600 text-lg mt-2">PTSD, 트라우마, 위기 상황에 대한 전문적인 개입과 치유를 제공합니다.</p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-8 bg-slate-50 rounded-xl p-6 border border-slate-200">
          <div className="text-center">
            <h3 className="text-lg font-semibold text-slate-900 mb-2">🆘 외상 및 위기 개입 안내</h3>
