      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-slate-900">연인 및 부부 관계</h1>
              <p className="text-slate-600 text-lg mt-2">연애 관계의 갈등부터 결혼 생활의 어려움까지 친밀한 관계의 문제를 다룹니다.</p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-8 bg-slate-50 rounded-xl p-6 border border-slate-200">
          <div className="text-center">
            <h3 className="text-lg font-semibold text-slate-900 mb-2">💕 연인관계 상담 안내</h3>
