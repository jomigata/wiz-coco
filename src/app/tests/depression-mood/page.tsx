      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-slate-900">우울 및 기분 문제</h1>
              <p className="text-slate-600 text-lg mt-2">우울감, 무기력감, 분노 조절 등 기분과 관련된 문제를 다룹니다.</p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-8 bg-slate-50 rounded-xl p-6 border border-slate-200">
          <div className="text-center">
            <h3 className="text-lg font-semibold text-slate-900 mb-2">⚠️ 중요 안내</h3>
