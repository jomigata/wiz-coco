      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-slate-900">생애주기별 적응</h1>
              <p className="text-slate-600 text-lg mt-2">아동기부터 노년기까지 각 생애주기별 발달과업과 위기를 지원합니다.</p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-8 bg-slate-50 rounded-xl p-6 border border-slate-200">
          <div className="text-center">
            <h3 className="text-lg font-semibold text-slate-900 mb-2">👶 생애주기별 발달 안내</h3>
