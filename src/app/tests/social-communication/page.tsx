      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-slate-900">사회적 기술 및 소통</h1>
              <p className="text-slate-600 text-lg mt-2">효과적인 의사소통과 사회적 기술 향상으로 원만한 인간관계를 형성합니다.</p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-8 bg-slate-50 rounded-xl p-6 border border-slate-200">
          <div className="text-center">
            <h3 className="text-lg font-semibold text-slate-900 mb-2">💬 소통 기술 향상 안내</h3>
