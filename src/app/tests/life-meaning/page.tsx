      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-slate-900">삶의 의미 및 실존적 문제</h1>
              <p className="text-slate-600 text-lg mt-2">삶의 근본적인 의미를 탐색하고 실존적 고민을 해결하여 충만한 삶을 지원합니다.</p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-8 bg-slate-50 rounded-xl p-6 border border-slate-200">
          <div className="text-center">
            <h3 className="text-lg font-semibold text-slate-900 mb-2">🌌 실존적 문제 상담 안내</h3>
