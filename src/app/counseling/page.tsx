...
<div className="pt-24 px-4 pb-12">
        <div className="max-w-4xl mx-auto bg-white/10 backdrop-blur-sm p-8 rounded-xl shadow-lg border border-slate-200">
          <h1 className="text-3xl font-bold text-slate-900 mb-6 text-center">상담 프로그램</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {/* 상담 프로그램 카드 */}
            <div className="bg-white/10 p-6 rounded-lg border border-slate-200 hover:bg-white/15 transition-colors">
