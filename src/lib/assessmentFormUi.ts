...
/** 수정 화면 — 테두리만 강조 */
export const FORM_INPUT_BORDERED =
  'w-full rounded-lg border-2 border-sky-400/50 bg-[#101f38]/90 px-3 py-2.5 text-base text-white placeholder:text-slate-500 transition-colors focus:outline-none focus:ring-2 focus:ring-sky-400/40 focus:border-sky-300/70 disabled:cursor-not-allowed disabled:opacity-55';
