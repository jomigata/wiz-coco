...
export const WELCOME_MESSAGE_SAMPLES: WelcomeMessageSample[] = [
  {
    label: '샘플 1',
    text:
      '검사는 편안한 마음으로 솔직하게 응답해 주시면 됩니다. 문의 사항은 심리 매니저에게 연락해 주세요.',
  },
  {
    label: '샘플 2',
    text:
      '[접속 안내] ① 이메일·문자로 받은 나의코드·비밀번호 확인 ② 내 검사실에 로그인 ③ 검사 목록에서 순서대로 실시. 검사 중 어려움이 있으면 심리 매니저에게 연락해 주세요.',
  },
  {
    label: '샘플 3',
    text:
      '안녕하세요. 이번 심리검사에 참여해 주셔서 감사합니다. 발송된 나의코드·비밀번호로 내 검사실에 접속한 뒤, 안내된 검사를 모두 완료해 주세요. 궁금한 점은 심리 매니저에게 문의해 주세요.',
  },
  {
    label: '샘플 4',
