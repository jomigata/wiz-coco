...
// 일반 상담(코드)용 문항 (genericJoinQuestions 사용)
list.push({ testId: 'generic', name: '일반 심리 문항 (상담(코드)용)' });
seen.add('generic');
...
/** 상담사 상담(코드) 생성 시 선택 가능한 검사 목록 (testId, name) */
