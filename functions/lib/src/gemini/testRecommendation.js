...
exports.generateTestRecommendations = generateTestRecommendations;
const client_1 = require("./client");
const MAX_RESULT_JSON_CHARS = 10000;
...
async function generateTestRecommendations(input) {
...
반드시 아래 JSON만 출력 (마크다운 코드블록 없이):
{
  ...
  "recommendations": [
    ...
    const recommendations = parsed.recommendations
        ...
        return Object.assign(Object.assign({}, r), { name: (match === null || match === void 0 ? void 0 : match.name) || r.name });
    });
    if (!recommendations.length) {
...
//# sourceMappingURL=testRecommendation.js.map