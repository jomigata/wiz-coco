...
exports.generateComprehensiveAssessmentReport = generateComprehensiveAssessmentReport;
...
async function generateComprehensiveAssessmentReport(input) {
...
반드시 JSON만 출력:
{
  ...
  "sections": [
    ...
    return Object.assign(Object.assign({}, parsed), { modelId: result.modelId, usage: result.usage });
}
//# sourceMappingURL=comprehensiveReport.js.map