...
const MAX_RESULT_JSON_CHARS = 12_000
...
export type AssessmentInterpretInput = {
  testType?: string
  testId?: string
  clientLabel?: string
  resultData?: unknown
...
export async function generateAssessmentInterpretation(
  input: AssessmentInterpretInput
): Promise<{ text: string; modelId: string; usage?: Awaited<ReturnType<typeof generateCounselReply>>['usage'] }> {
